...
public class UsuarioEInvitadoProductosController {
    ...
    // buscarProductosPorRangoDePrecio(
    ...
    // usuarioEInvitadoProductoServicio.buscarProductosPorRangoDePrecio(min,
    // max,
    // page, size);
    // return ResponseEntity.ok(productos);
    // } catch (Exception e) {
    ...
    public ResponseEntity<List<Map<String, Object>>> buscarProductosPorRangoDePrecio(
        ...
        List<Map<String, Object>> productos = usuarioEInvitadoProductoServicio.buscarProductosPorRango(min,
                max, categoria,
                marca, page, size);
        return ResponseEntity.ok(productos);
    }
