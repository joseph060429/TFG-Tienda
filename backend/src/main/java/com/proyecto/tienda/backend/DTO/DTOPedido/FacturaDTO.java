...
// // Agrego el logo de mi empresa
// Image imagenLogo = Image.getInstance(rutaLogo);
// imagenLogo.setAlignment(Element.ALIGN_CENTER);
// imagenLogo.scaleToFit(200, 200); // Aquí puedes ajustar el ancho y alto
// deseado
// document.add(imagenLogo);
...
// // ID del pedido
// PedidosModelo pedido = facturaDTO.getPedidosModelo();
// Paragraph id_pedido = new Paragraph("ID del pedido: " + pedido.get_id(),
// boldFont);
// document.add(id_pedido);

// // Datos del cliente
// UsuarioModelo usuario = facturaDTO.getUsuarioModelo();
// Paragraph infoCliente = new Paragraph("Cliente: " + usuario.getNombre() + " "
// + usuario.getApellido(),
// boldFont);
// document.add(infoCliente);
...
// for (ProductoPedidoDTO producto : productos) {
// tabla.addCell(new Phrase(producto.getNombre(), normalFont));
// tabla.addCell(new Phrase(String.valueOf(producto.getPrecioProducto()),
// normalFont));
// tabla.addCell(new Phrase(String.valueOf(producto.getCantidadPedida()),
// normalFont));
...
// PdfPCell celdaEnvio = new PdfPCell(new Phrase("Dirección de envío:",
// boldFont));
// celdaEnvio.setBackgroundColor(Color.LIGHT_GRAY);
// celdaEnvio.setHorizontalAlignment(Element.ALIGN_CENTER);
// tablaEnvio.addCell(celdaEnvio);

// celdaEnvio = new PdfPCell(new Phrase(pedido.getDireccionCompletaEnvio(),
// normalFont));
// celdaEnvio.setBorderWidth(0);
// celdaEnvio.setHorizontalAlignment(Element.ALIGN_CENTER);
// tablaEnvio.addCell(celdaEnvio);
...
// PdfPCell celdaFacturacion = new PdfPCell(new Phrase("Dirección de
// facturación:", boldFont));
// celdaFacturacion.setBackgroundColor(Color.LIGHT_GRAY);
// celdaFacturacion.setHorizontalAlignment(Element.ALIGN_CENTER);
// tablaFacturacion.addCell(celdaFacturacion);

// celdaFacturacion = new PdfPCell(new
// Phrase(pedido.getDireccionCompletaFacturacion(), normalFont));
// celdaFacturacion.setBorderWidth(0);
// celdaFacturacion.setHorizontalAlignment(Element.ALIGN_CENTER);
// tablaFacturacion.addCell(celdaFacturacion);
