        ...
        <div class="d-flex justify-center align-center" style="max-width: 60%; margin: auto;">
            ...
            <q-form @submit.prevent="registroUsuario" @reset="borrar" class="q-gutter-md">
                ...
                <div class="q-mt-lg d-flex justify-around">
                    <!-- Boton de enviar -->
                    <q-btn label="Actualizar cuenta" type="submit" class="full-width enviar-button col-xs-12 col-sm-6">
                        <q-icon name="mdi-account-edit" class="q-ml-md inline"></q-icon> <!-- Icono para el botón -->
                    </q-btn>
