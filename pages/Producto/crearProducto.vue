    ...
    <div style="overflow: auto;">
        <!-- <div class="container"> -->
            ...
            <div class="d-flex justify-center align-center" style="max-width: 60%; margin: auto;">
                ...
                <q-form @submit.prevent="crearProductos" @reset="borrar"class="q-gutter-xs" style="max-width: 100%; max-height: 60vh; margin: auto;">
                    ...
                    <q-input filled v-model="datosProducto.nombreProducto" label="Nombre del producto *"
                        lazy-rules :rules="[
                      ...
                      <q-input filled v-model="datosProducto.descripcionProducto" label="Descripción del producto *"
                        ...
                        <q-input filled v-model="datosProducto.precioProducto" label="Precio del producto *" hint="Precio"
                        lazy-rules :rules="[
                            val => val && val.length > 0 || 'Por favor, introduce algo',
                        ...
                        hint="Cantidad" lazy-rules :rules="[
                            val => val && val.length > 0 || 'Por favor, introduce algo',
                    ...
                    <!-- Campo marcaProducto -->
                    <q-input filled v-model="datosProducto.marcaProducto" label="Marca del producto *" hint="Marca"
                        lazy-rules :rules="[
                            val => val && val.length > 0 || 'Por favor, introduce algo',
                    ...
                    <q-input filled v-model="datosProducto.especificacionesTecnicas"
                        label="Especificaciones técnicas del producto *" hint="Especificaciones" lazy-rules :rules="[
                            val => val && val.length > 0 || 'Por favor, introduce algo',
                            val => val.length >= 2 || 'Las especificaciones técnicas del producto debe tener al menos 2 caracteres'
                        ]">
                        <template v-slot:prepend>
                    ...
                    <q-file v-model="datosProducto.imagen" @update:model-value="onFileChange" filled label="Imagen del Producto *">
...
function onFileChange(event) {
    ...
    console.log(datosProducto.imagen, 'chulo')
}
...
const crearProductos = async () => {
    ...
    try {
        ...
        formData.append("especificacionesTecnicas", datosProducto.especificacionesTecnicas);
        ...
        console.log("Response crear producto", response);
        if(response.status === 200) {
            mostrarAlertaExito('Producto creado correctamente', quasar);
        }
    } catch (error) {
